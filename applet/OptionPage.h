...
class OptionsEncoder : public Encoder {
	/**
...
public:
	 ...
	 **/
	OptionsEncoder(int _max = 127, int _min = 0, const char *_name = NULL, int init = 0, encoder_handle_t _handler = NULL) : Encoder(_name, _handler) {
		initOptionsEncoder(_max, _min, _name, init, _handler);
	}
	 ...
	 **/
	void initOptionsEncoder(int _max = 128, int _min = 0, const char *_name = NULL, int init = 0,
...
public:
   ...
   **/
  OptionsPage(Encoder *e1 = NULL, Encoder *e2 = NULL, Encoder *e3 = NULL, Encoder *e4 = NULL) {
...
void OptionsPage::finalize() {
}

void OptionsPage::displayNames() {
}


void  OptionsEncoder::displayAt(int x) {
  
}
int OptionsEncoder::update(encoder_t *enc) {
